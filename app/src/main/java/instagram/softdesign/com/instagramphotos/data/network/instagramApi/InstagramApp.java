		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String photo = jsonObj.getJSONObject("user").getString("profile_picture");

					mSession.storeAccessToken(mAccessToken, id, user, name, photo);
